...
- (void)setLocation:(CLLocation *)location forKey:(NSString *)key forBearing:(NSString *)Bearing
{
    [self setLocation:location forKey:key forBearing:Bearing withCompletionBlock:nil];
}

- (void)setLocation:(CLLocation *)location
             forKey:(NSString *)key
            forBearing:(NSString *)Bearing
               ...
               withBlock:(GFCompletionBlock)block
{
    ...
    if (location != nil) {
        ...
        value = @{ @"l": @[ lat, lng ], @"g": geoHash, @"bearing": Bearing };
        priority = geoHash;
    } else {
        value = nil;
        priority = nil;
