...
class ARMainYourTripsVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
  ...
  //  weak var delegateBack: LeftMenuProtocol?
   ...
   @IBOutlet weak var segmentedcontrol: UISegmentedControl!
    ...
    var arrayOfCash:NSMutableArray=NSMutableArray()
    var arrayOfriderName:NSMutableArray=NSMutableArray()
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
      ...
      //  if(self.tripsdetail == "yourtrips"){
        ...
        let priceValue : Int = arrayOfPrice.object(at: indexPath.row) as! Int
        ...
        if dropLoc == nil || dropLoc == ""{
            ...
            if self.appDelegate.updatelocatiostatus == 1{
    ...
    func callRidesList(){
        ...
        self.activityView.startAnimating()
            ...
            arrayImages.remove("")
        arrayOfCash.removeAllObjects()
        arrayOfCash.remove("")
        arrayOfriderName.removeAllObjects()
        arrayOfriderName.remove("")
                     ...
                     //  let paymentStatus: NSString = (dataDict as AnyObject).object(forKey: "payment_status") as! NSString!
                       ...
                       /* let paymentStatus = (dataDict as AnyObject).object(forKey: "total_price") as? Int
                        ...
                        if let intPrice = (dataDict as AnyObject).object(forKey: "total_price") as? Int{
                            ...
                            let images = (dataDict as AnyObject).object(forKey: "rider_profile") as? String
                        let cash = (dataDict as AnyObject).object(forKey: "payment_mode")as? String
                        ...
                        self.arrayOfCash.add("")
                        
                        }
                        else{
                        
                        self.arrayOfCash.add(cash as String!)
                        }
                        if riderName == nil{
                        
                        self.arrayOfriderName.add("")
                        }
                        else{
                        self.arrayOfriderName.add(riderName as String!)
                        }
    ...
    /*func callupcomingrides(){
        ...
        var urlstring:String = "\(live_Driver_url)requests/rideLaterList/rider_id/\(self.appDelegate.userid!)"
        urlstring = urlstring.addingPercentEncoding( withAllowedCharacters: .urlQueryAllowed)!
        print(urlstring)
        let manager : AFHTTPRequestOperationManager = AFHTTPRequestOperationManager()
        manager.responseSerializer.acceptableContentTypes =  NSSet(objects: "text/plain", "text/html", "application/json", "audio/wav", "application/octest-stream") as Set<NSObject>
