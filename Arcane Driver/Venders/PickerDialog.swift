...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [[String: String]], selected: String? = nil, callback: @escaping PickerCallback) {
        ...
        NotificationCenter.default.addObserver(self, selector: "deviceOrientationDidChange:", name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width: 300, height: 230 + kPickerDialogDefaultButtonHeight
        ...
        let dialogContainer = UIView(frame: CGRect(x: screenSize.width - dialogSize.width / 2, y: screenSize.height - dialogSize.height / 2, dialogSize.width, width: screenSize.height - dialogSize.height / 2, dialogSize.width, height: dialogSize.height))
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: "buttonTapped:", for: UIControlEvents.touchUpInside)
        ...
        self.doneButton.addTarget(self, action: "buttonTapped:", for: UIControlEvents.touchUpInside)
