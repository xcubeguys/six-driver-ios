    ...
    */
    ...
    override open func willMove(toSuperview newSuperview: UIView!) {
        if newSuperview != nil {
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(trying(_:)), name: NSNotification.Name.UITextFieldTextDidChange, object: self)
            
//            NotificationCenter.default.addObserver(self, action: #selector(TextFieldEffects.trying(_:)), for: UIControlEvents.editingChanged)
    ...
    func trying(_ textField:UITextField)
    {
        if text == ""{
